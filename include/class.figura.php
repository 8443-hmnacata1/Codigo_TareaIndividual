<?php
	abstract class figura{
		...
		public static function get_form(){
			...
			<h1 align="center" style="margin: 10px;color:black" >TRABAJO INDIVIDUAL</h1>
			<h3 align="center" style="margin: 10px;color:black" >Nombre: Heidy Ñacata</h3>
			<h3 align="center" style="margin: 10px;color:black" >NRC: 8443</h3>
			<h3 align="center" style="margin: 10px;color:black" >Fecha de Entrega: 16/02/2023</h3>
			...
			<div class="card-body ">
			  <h5 class="card-title">Ingrese los Datos de la Figura:</h5>
			...
			<div class="row justify-content-md-center">
			  ...
			  <div class="input-group">
				<div class="input-group-text"><h3>Lado 1</h3></div>
				<input type="text" class="form-control" id="inlineFormInputGroupUsername" placeholder="Ingrese Lado 1">
			  </div>
			  </div>
			  ...
			  <label class="visually-hidden" for="inlineFormInputGroupUsername">Username</label>
			  <div class="input-group">
				<div class="input-group-text"><h3>Lado 2</h3></div>
				<input type="text" id="lado2" class="form-control" id="inlineFormInputGroupUsername" placeholder="Ingrese Lado 2">
			  </div>
			  </div>
			
			  <div class="col-12">
			  <div class="input-group w-80">
              <span class="input-group-text" id="basic-addon1"> <h3>Lado 3</h3> &nbsp
              ...
              <input type="text" class="form-control" id="lado3" placeholder="Ingrese Lado 3" aria-label=Ingrese Lado 3" aria-describedby="basic-addon1" >
            </div>
			  </div>
